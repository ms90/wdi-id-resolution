...
public class NeedlemanWunschSimilarityFunction implements SimilarityFunction 
{
	/**
	 * Compares two strings, uses Needleman-Wunsch similarity from the SecondString library. 
	 * @author Maxim
	 *
	 */
